...
import BackToTop from "quasar-framework/src/directives/back-to-top.js";

export const Quasar = { install, icons };
export const QuasarComponents = { QBtn, QCard, QCardMain, QCardSeparator, QCardTitle, QChip, QIcon, QItem, QItemMain, QItemSeparator, QItemSide, QItemTile, QLayout, QLayoutHeader, QList, QListHeader, QModal, QModalLayout, QPage, QPageContainer, QPopover, QProgress, QTooltip, QToolbar, QToolbarTitle };
export const QuasarDirectives = { BackToTop };
