...
/*
thread_connections: 82
traffic_all: "0.4652522"
traffic_perSecond: "1.0"
*/
...
const bytes_traffic = randomValue(0, 1073741824, 1099511627776, -1048576, 1048576);
...
const innodb_reads_persecond = randomValue(100, 10, 1000, -10, 10);
const innodb_writes_persecond = randomValue(100, 10, 1000, -10, 10);
...
export const getDatabaseInfo = (param, socket) => {
  ...
  return {
    ...
    // 当前数据库总流速
    "bytes_traffic": bytes_traffic.next(),
    // 当前数据库接收速率
    ...
    // 数据读操作耗时
    "innodb_reads_persecond": innodb_reads_persecond.next(),
    // 数据写操作耗时
    "innodb_writes_persecond": innodb_writes_persecond.next(),
  };
}
